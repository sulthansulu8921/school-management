...
import { Search, Bell, ChevronDown, User, Receipt, X } from 'lucide-react';
        ...
        const fetchResults = async () => {
            ...
            try {
                ...
                const [studentsRes, receiptsRes] = await Promise.all([
                    axios.get(`${baseUrl}/api/students/?search=${searchQuery}`),
                    axios.get(`${baseUrl}/api/payments/receipts/?search=${searchQuery}`)
                ]);
            ...
            <div className="flex items-center gap-8">
                ...
                <div className="flex items-center gap-4 pl-8 border-l border-gray-100 cursor-pointer group">
                    <div className="text-right flex flex-col items-end">
                        ...
                        <span className="text-sm font-bold text-gray-800">LOURDES MATA CENTRAL SCHOOL</span>
                    </div>
